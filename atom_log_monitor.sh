...
if [ "$UI_IN_ATOM" = "true" ]
then
   FILES="AtomConsolelog.txt.0 CRlog.txt.0 lighttpderror.log WiFilog.txt.0 ap_init.txt.0 hostapd_error_log.txt XsmartLog.txt.0"
else
   FILES="AtomConsolelog.txt.0 CRlog.txt.0 WiFilog.txt.0 XsmartLog.txt.0"
fi
